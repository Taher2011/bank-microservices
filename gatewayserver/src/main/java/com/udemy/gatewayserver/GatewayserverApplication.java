...
public class GatewayserverApplication {
	...
	public PropertyHolder holder() {
		...
		holder.setAuthorizationHeaderAccount(environment.getProperty("authorization.header.account"));
		holder.setAuthorizationHeaderLoan(environment.getProperty("authorization.header.loan"));
		holder.setAuthorizationHeaderCard(environment.getProperty("authorization.header.card"));
		return holder;
	}
